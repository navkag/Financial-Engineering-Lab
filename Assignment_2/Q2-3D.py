...
def main():
        S_0, K, T, r, sigma, M = 100, 100, 1, 0.08, 0.3, 10
        # Varying S_0 prices.
        ...
        plt.title("Asian Call Option Prices vs spot for part (a)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(25, 200, 50), S_0_prices_1[:, 1])
        plt.title("Asian Put Option Prices vs spot for part (a)")
        plt.savefig('Asian Option Prices vs spot part (a)')
        plt.show()
        ...
        plt.title("Asian Call Option Prices vs spot for part (b)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(25, 200, 50), S_0_prices_2[:, 1])
        plt.title("Asian Put Option Prices vs spot for part (b)")
        plt.savefig('Asian Option Prices vs spot part (b)')
        plt.show()
        ...
        plt.title("Asian Call Option Prices vs strike for part (a)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(25, 200, 50), K_prices_1[:, 1])
        plt.title("Asian Put Option Prices vs strike for part (a)")
        plt.savefig('Asian Option Prices vs strike for part (a)')
        plt.show()
        ...
        plt.title("Asian Call Option Prices vs strike for part (b)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(25, 200, 50), K_prices_2[:, 1])
        plt.title("Asian Put Option Prices vs strike for part (b)")
        plt.savefig('Asian Option Prices vs strike for part (b)')
        plt.show()
        ...
        for r in np.linspace(1e-4, 0.9, 50):
        ...
        plt.figure(figsize=(15, 4))
        plt.subplot(1, 2, 1)
        plt.plot(np.linspace(1e-4, 0.9, 50), r_prices_1[:, 0])
        plt.title("Asian Call Option Prices vs rate for part (a)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(1e-4, 0.9, 50), r_prices_1[:, 1])
        plt.title("Asian Put Option Prices vs rate for part (a)")
        plt.savefig('Asian Option Prices vs rate for part (a)')
        plt.show()

        r_prices_2 = np.array(r_prices_2)
        plt.figure(figsize=(15, 4))
        plt.subplot(1, 2, 1)
        plt.plot(np.linspace(1e-4, 0.9, 50), r_prices_2[:, 0])
        plt.title("Asian Call Option Prices vs rate for part (b)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(1e-4, 0.9, 50), r_prices_2[:, 1])
        plt.title("Asian Put Option Prices vs rate for part (b)")
        plt.savefig('Asian Option Prices vs rate for part (b)')
        plt.show()
        ...
        for sigma in np.linspace(0.05, 0.8, 50):
        ...
        plt.figure(figsize=(15, 4))
        plt.subplot(1, 2, 1)
        plt.plot(np.linspace(0.05, 0.8, 50), sigma_prices_1[:, 0])
        plt.title("Asian Call Option Prices vs volatility for part (a)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(0.05, 0.8, 50), sigma_prices_1[:, 1])
        plt.title("Asian Put Option Prices vs volatility for part (a)")
        plt.savefig('Asian Option Prices vs volatility for part (a)')
        plt.show()

        sigma_prices_2 = np.array(sigma_prices_2)
        plt.figure(figsize=(15, 4))
        plt.subplot(1, 2, 1)
        plt.plot(np.linspace(0.05, 0.8, 50), sigma_prices_2[:, 0])
        plt.title("Asian Call Option Prices vs volatility for part (b)")

        plt.subplot(1, 2, 2)
        plt.plot(np.linspace(0.05, 0.8, 50), sigma_prices_2[:, 1])
        plt.title("Asian Put Option Prices vs volatility for part (b)")
        plt.savefig('Asian Option Prices vs volatility for part (b)')
        plt.show()
        ...
        for K in K_list:
          ...
          plt.figure(figsize=(15, 4))
          plt.subplot(1, 2, 1)
          plt.plot(np.arange(5, 21), M_prices_1[:, 0])
          plt.title(f"Asian Call Option Prices vs #Sub-intervals for part (a) with K: {K}")

          plt.subplot(1, 2, 2)
          plt.plot(np.arange(5, 21), M_prices_1[:, 1])
          plt.title(f"Asian Put Option Prices vs #Sub-intervals for part (a) with K: {K}")
          plt.savefig(f"Asian Option Prices versus #Sub-intervals for part (a) with K: {K}")
          plt.show()

          plt.figure(figsize=(15, 4))
          plt.subplot(1, 2, 1)
          plt.plot(np.arange(5, 21), M_prices_2[:, 0])
          plt.title(f"Asian Call Option Prices vs #Sub-intervals for part (b) with K: {K}")

          plt.subplot(1, 2, 2)
          plt.plot(np.arange(5, 21), M_prices_2[:, 1])
          plt.title(f"Asian Put Option Prices vs #Sub-intervals for part (b) with K: {K}")
          plt.savefig(f"Asian Option Prices vs #Sub-intervals for part (b) with K: {K}")
          plt.show()
        ...
        axes[0].set_title("Asian Call Option Prices vs S_0 and K for part (a)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("K")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_K_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and K for part (a)")
        ...
        plt.savefig("Asian Option Prices vs S_0 and K for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, S_0_K_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs S_0 and K for part (b)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("K")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_K_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and K for part (b)")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("K")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs S_0 and K for part (b)")
        plt.show()
        ...
        axes[0].set_title("Asian Call Option Prices vs S_0 and rate for part (a)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("r")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_r_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and rate for part (a)")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("r")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs S_0 and rate for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, S_0_r_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs S_0 and rate for part (b)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("r")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_r_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and rate for part (b)")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("r")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs S_0 and rate for part (b)")
        plt.show()
        ...
        axes[0].set_title("Asian Call Option Prices vs S_0 and volatility for part (a)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_sigma_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and volatility for part (a)")
        axes[1].set_xlabel("S_0")
        ...
        plt.savefig("Asian Option Prices vs S_0 and volatility for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, S_0_sigma_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs S_0 and volatility for part (b)")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_sigma_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs S_0 and volatility for part (b)")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("volatility")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs S_0 and volatility for part (b)")
        plt.show()

        S_0, K, T, r, sigma, M = 100, 95, 1, 0.08, 0.3, 10
        ...
        axes[0].set_title(f"Asian Call Option Prices vs S_0 and #sub-intervals for part (a) with K: {K}")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_M_prices_1[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs S_0 and #sub-intervals for part (a) with K: {K}")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig(f"Asian Option Prices vs S_0 and #sub-intervals for part (a) with K: {K}")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, S_0_M_prices_2[:, 0], cmap='Greens')
        axes[0].set_title(f"Asian Call Option Prices vs S_0 and #sub-intervals for part (b) with K: {K}")
        axes[0].set_xlabel("S_0")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, S_0_M_prices_2[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs S_0 and #sub-intervals for part (b) with K: {K}")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig(f"Asian Option Prices vs S_0 and #sub-intervals for part (b) with K: {K}")
        plt.show()
        ...
        S_0, K, T, r, sigma, M = 100, 105, 1, 0.08, 0.3, 10
        ...
        axes[0].set_title("Asian Call Option Prices vs K and rate for part (a)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("r")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_r_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs K and rate for part (a)")
        axes[1].set_xlabel("K")
        axes[1].set_ylabel("r")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs K and rate for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, K_r_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs K and rate for part (b)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("r")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_r_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs K and rate for part (b)")
        axes[1].set_xlabel("K")
        axes[1].set_ylabel("r")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs K and rate for part (b)")
        plt.show()
        ...
        axes[0].set_title("Asian Call Option Prices vs K and volatility for part (a)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_sigma_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs K and volatility for part (a)")
        axes[1].set_xlabel("K")
        axes[1].set_ylabel("volatility")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs K and volatility for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, K_sigma_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs K and volatility for part (b)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_sigma_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs K and volatility for part (b)")
        axes[1].set_xlabel("K")
        axes[1].set_ylabel("volatility")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs K and volatility for part (b)")
        plt.show()
        ...
        axes[0].set_title(f"Asian Call Option Prices vs K and #sub-intervals for part (a)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_M_prices_1[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs K and #sub-intervals for part (a)")
        axes[1].set_xlabel("S_0")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig(f"Asian Option Prices vs K and #sub-intervals for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, K_M_prices_2[:, 0], cmap='Greens')
        axes[0].set_title(f"Asian Call Option Prices vs K and #sub-intervals for part (b)")
        axes[0].set_xlabel("K")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, K_M_prices_2[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs K and #sub-intervals for part (b)")
        axes[1].set_xlabel("K")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig(f"Asian Option Prices vs K and #sub-intervals for part (b)")
        plt.show()

        S_0, K, T, r, sigma, M = 100, 100, 1, 0.08, 0.3, 10

        # plot r sigma plots.
        R = np.linspace(0.3, 0.7, 50)
        Sigma = np.linspace(0.3, 0.7, 50)
        ...
        axes[0].set_title("Asian Call Option Prices vs rate and volatility for part (a)")
        axes[0].set_xlabel("rate")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, R_sigma_prices_1[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs rate and volatility for part (a)")
        ...
        plt.savefig("Asian Option Prices vs rate and volatility for part (a)")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, R_sigma_prices_2[:, 0], cmap='Greens')
        axes[0].set_title("Asian Call Option Prices vs rate and volatility for part (b)")
        axes[0].set_xlabel("rate")
        axes[0].set_ylabel("volatility")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, R_sigma_prices_2[:, 1], cmap='Greens')
        axes[1].set_title("Asian Put Option Prices vs rate and volatility for part (b)")
        axes[1].set_xlabel("rate")
        axes[1].set_ylabel("volatility")
        axes[1].set_zlabel("P_0")
        ...
        plt.savefig("Asian Option Prices vs rate and volatility for part (b)")
        plt.show()
        ...
        axes[0].set_title(f"Asian Call Option Prices vs rate and #sub-intervals for part (a) with K: {K}")
        axes[0].set_xlabel("rate")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, R_M_prices_1[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs rate and #sub-intervals for part (a) with K: {K}")
        axes[1].set_xlabel("rate")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        plt.tight_layout()

        plt.savefig(f"Asian Option Prices vs rate and #sub-intervals for part (a) with K: {K}")
        plt.show()

        fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

        axes[0].scatter3D(x_axis, y_axis, R_M_prices_2[:, 0], cmap='Greens')
        axes[0].set_title(f"Asian Call Option Prices vs rate and #sub-intervals for part (b) with K: {K}")
        axes[0].set_xlabel("rate")
        axes[0].set_ylabel("M")
        axes[0].set_zlabel("C_0")

        axes[1].scatter3D(x_axis, y_axis, R_M_prices_2[:, 1], cmap='Greens')
        axes[1].set_title(f"Asian Put Option Prices vs rate and #sub-intervals for part (b) with K: {K}")
        axes[1].set_xlabel("rate")
        axes[1].set_ylabel("M")
        axes[1].set_zlabel("P_0")
        plt.tight_layout()

        plt.savefig(f"Asian Option Prices vs rate and #sub-intervals for part (b) with K: {K}")
        plt.show()
        ...
        for K in [95, 100, 105]:
                S_0, T, r, sigma, M = 100, 1, 0.08, 0.3, 10

                # plot rate M plots with K = 95
                Sigma = np.linspace(0.3, 0.6, 50)
                M = [i for i in range(5, 16)]
                ...
                axes[0].set_title(f"Asian Call Option Prices vs volatility and #sub-intervals for part (a) with K: {K}")
                axes[0].set_xlabel("volatility")
                axes[0].set_ylabel("M")
                axes[0].set_zlabel("C_0")

                axes[1].scatter3D(x_axis, y_axis, sigma_M_prices_1[:, 1], cmap='Greens')
                axes[1].set_title(f"Asian Put Option Prices vs volatility and #sub-intervals for part (a) with K: {K}")
                axes[1].set_xlabel("volatility")
                axes[1].set_ylabel("M")
                axes[1].set_zlabel("P_0")
                plt.tight_layout()

                plt.savefig(f"Asian Option Prices vs volatility and #sub-intervals for part (a) with K: {K}")
                plt.show()

                fig, axes = plt.subplots(1, 2, figsize=(12, 5), subplot_kw={'projection': '3d'})

                axes[0].scatter3D(x_axis, y_axis, sigma_M_prices_2[:, 0], cmap='Greens')
                axes[0].set_title(f"Asian Call Option Prices vs volatility and #sub-intervals for part (b) with K: {K}")
                axes[0].set_xlabel("volatility")
                axes[0].set_ylabel("M")
                axes[0].set_zlabel("C_0")

                axes[1].scatter3D(x_axis, y_axis, sigma_M_prices_2[:, 1], cmap='Greens')
                axes[1].set_title(f"Asian Put Option Prices vs volatility and #sub-intervals for part (b) with K: {K}")
                axes[1].set_xlabel("volatility")
                axes[1].set_ylabel("M")
                axes[1].set_zlabel("P_0")
                plt.tight_layout()

                plt.savefig(f"Asian Option Prices vs volatility and #sub-intervals for part (b) with K: {K}")
                plt.show()
